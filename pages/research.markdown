...
{% include paper.html
  ...
  tldr="[TL;DR] Social claims in machine learning research often fail to materialize; this paper identifies the conditions that make it difficult to hold such claims accountable."
...
{% include paper.html
  ...
  tldr="[TL;DR] To motivate ethical reflection among ML scientists, this paper develops the concept of "claim replicability" as a basis for new forms of accountability."
