...
{% include paper.html
  ...
  tldr='> To motivate ethical reflection among ML scientists, this paper develops the concept of "claim replicability" as a basis for new forms of accountability.'
