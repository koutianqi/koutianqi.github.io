...
{% include paper.html
  ...
  tldr="[TL;DR] Social claims in machine learning research often do not pan out, this paper diagnoses conditions that make holding social claims accountable difficult."
