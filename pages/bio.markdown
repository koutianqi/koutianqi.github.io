...
<div markdown="1">
Based at Penn State Information School, my doctoral training is in Philosophy of Science and Sciecne and Technology Studies. I am a core member of [Working Futures](https://workingfutures.net) advised by [Dr. Dana Calacci](https://www.dcalacci.net). In addition, I am an affiliate of [Center for Socially Responsible Artificial Intelligence](https://csrai.psu.edu), a Liberal Tech Scholar at critical tech pubilcation [LOGIC(S)](https://logicmag.io), and a visiting scholar at [Critical Technocultures Lab](https://www.crit-technocultures.com) at the School of Interactive Computing at Georgia Tech.
