...
- _**dissecting** how harms emerge from communication (such as AI hype)_
- _**developing** responsible communication norms to mitigate these harms_
- _**enforcing** such norms through academic, policy, or legal reforms_ 
